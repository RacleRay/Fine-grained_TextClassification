...
from models.multi_class_rnn import (
    BertRNN,
    AlbertRNN,
)
...
class RNNConfig:
    ...
    n_layers = 1
    bidirectional = True
    lstm_dropout = 0.5  # lstm模型。使用awdlstm时，在BertRNN中修改，一般用默认。


class MultiClassRnnRunner(BaseRunner):
    def __init__(
        self,
        model_type,
        model_file,
        ...
        **kwargs
        ...
        """
        MODEL_CLASSES = {
            "bert": (BertConfig, BertRNN, BertTokenizer),
            ...
            "albert": (AlbertConfig, AlbertRNN, BertTokenizer),
